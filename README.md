...
| **Safari** | ✅ Compatible | Full support for Safari and WebKit rendering. Share Button shares a painting with a WHITE background canvas. The swatches push up against the banner at actual screen size. This was not the case when working with Safari on the live server.|
